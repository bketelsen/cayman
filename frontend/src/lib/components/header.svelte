<script lang="ts">
    ...
    export let title: string = "Cayman";
...
<header class="col-span-12 flex items-center gap-2 lg:gap-4">
    ...
    <div class="grow">
        ...
        <h2 class="lg:text-xl lg:font-light">{subtitle}</h2>
    </div>
    ...
    <div class="dropdown dropdown-end z-10">
        ...
        <!-- <ul
            tabindex="0"
            class="menu dropdown-content rounded-box bg-base-100 mt-3 w-80 p-2 shadow-2xl"
        >
            <li>
                <a class="gap-4">
                    <div class="avatar">
